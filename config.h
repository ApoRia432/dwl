...
static const float shadow_color_focus[4] = COLOR(0x000000ff);
...
static const Rule rules[] = {
	...
	{ "st",     NULL,    0,            0,           -1, 0,   0,   0,   0,   0.94 }, /* Start on currently visible tags floating, not tiled */
	...
	{ "steam",            NULL,         0,            1,           -1, 0.5,   0.5,   0.5,   0,   1.0 }, /* Start on currently visible tags floating, not tiled */
	{ "TUI.float",        NULL,         0,            1,           -1, 0.5, 0.5, 0.7, 0.7, 0.94 }, /* Start on currently visible tags floating, not tiled */
...
static const MonitorRule monrules[] = {
	...
	*/
	{ NULL,       0.5f, 1,      1.0,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
};
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_M,          spawn,          SHCMD("wl-mirror DP-1")},
