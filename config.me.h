...
static const float opacity_active = 0.93;
...
static const int corner_radius_only_floating = 8; /* only apply corner_radius and corner_radius_inner to floating windows */
...
static const Rule rules[] = {
	...
	{ "TUI.float",        NULL,         0,            1,           -1, 0.5, 0.5, 0.7, 0.7 }, /* Start on currently visible tags floating, not tiled */
	{ NULL,               "Open File",  0,            1,           -1, 0.5, 0.5, 0.7, 0.7 }, /* Start on currently visible tags floating, not tiled */
	{ NULL,               "Picture in picture",  0,   1,           -1, 0.99, 0.99, 0.25, 0.25 }, /* Start on currently visible tags floating, not tiled */
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_b,          spawn,          SHCMD("chromium")},
	{ MODKEY,                    XKB_KEY_d,          spawn,          SHCMD("chromium --new-window --app='https://discord.com/channels/@me'")},
	{ MODKEY,                    XKB_KEY_g,          spawn,          SHCMD("chromium --new-window --app='https://grok.com/'")},
	{ 0,                         XKB_KEY_Print,      spawn,          SHCMD("hyprshot -m output -o \"$HOME/Pictures/Screenshots\"")},
	{ MODKEY,                    XKB_KEY_Print,      spawn,          SHCMD("hyprshot -m region -o \"$HOME/Pictures/Screenshots\"")},
